...
setDefaultActive();
    ...
    $('#btn_simpan').on('click', function () {
        ...
        if (nama_donatur == "" || telp_donatur == "" || alamat_donatur == "") {
            ...
            $.ajax({
                type: "post",
                url: "<?php echo base_url();?>/index.php/modul_keuangan_yayasan/mst_donatur/aksi_tam" +
                        "bah_mst_donatur",
                data: {
    ...
    $("body").on("click", "#btn_hapus", function () {
        ...
        $.ajax({
            type: "post",
            url: "<?php echo base_url();?>index.php/modul_keuangan_yayasan/mst_donatur/aksi_hapu" +
                    "s_mst_donatur",
            data: {
