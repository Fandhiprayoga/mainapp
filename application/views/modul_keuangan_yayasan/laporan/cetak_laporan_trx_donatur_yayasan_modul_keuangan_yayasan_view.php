...
<body>
    ...
    <div class="grid">
        ...
        <div class="tabel_plate">
            <hr>
            <br>
            <p align="center" style="font-weight:bold;">LAPORAN TRANSAKSI DONATUR YAYASAN 
            ...
            <table >
                ...
                <?php 
                            ...
                            (sum(nominal_trx_donatur_yayasan) over()) as total,
                            (select nama_donatur from mst_donatur where id_donatur=trx_donatur_yayasan.id_donatur) as nama_donatur,
                            (select telp_donatur from mst_donatur where id_donatur=trx_donatur_yayasan.id_donatur) as telp_donatur,
                            (select alamat_donatur from mst_donatur where id_donatur=trx_donatur_yayasan.id_donatur) as alamat_donatur 
                            from trx_donatur_yayasan 
                            where tgl_trx_donatur_yayasan between '".$tgl_awal."' and '".$tgl_akhir."'")->result_array();
                            ...
                            if(count($a))
                            {
                                ...
                                foreach($a as $a)
                                {
                                    echo "<tr style='width:100%;'>
                                            ...
                                            <td>".$a['tgl_trx_donatur_yayasan']."</td>
                                            <td>Rp.".$a['nominal_trx_donatur_yayasan']."</td>
                                        </tr>";
                                        $i++;
                                }
