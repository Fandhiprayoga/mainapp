...
<head>
  ...
  <title><?php echo $a[0]['nama_mainapp'];?> | MODUL KEGIATAN</title>
    ...
    <aside class="main-sidebar">
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li class=""><a href="<?php echo base_url();?>index.php/modul_kegiatan/beranda"><i class="fa fa-home"></i>
          ...
          <?php
            ...
            $data_menu=$this->db->query("select * from menu where id_modul='7' order by order_menu asc" )->result_array();
