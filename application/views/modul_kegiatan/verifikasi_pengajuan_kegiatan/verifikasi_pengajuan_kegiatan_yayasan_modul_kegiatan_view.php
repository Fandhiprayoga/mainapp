...
<section class="content-header">
      <h1>
        verifikasi pengajuan kegiatan yayasan
        <small>Halaman kelola verifikasi_pengajuan_kegiatan</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fas fa-home"></i> Beranda</a></li>
        <li><a href="#">list verifikasi pengajuan kegiatan yayasan</a></li>
    ...
    <div class="container-fluid">
          <div class="box box-danger">
            <div class="box-header with-border">
              <h3 class="box-title">List verifikasi pengajuan kegiatan yayasan</h3>
