...
<section class="content-header">
      <h1>
        acc pengajuan kegiatan yayasan
        <small>Halaman kelola acc_pengajuan_kegiatan</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fas fa-home"></i> Beranda</a></li>
        <li><a href="#">list acc pengajuan kegiatan yayasan</a></li>
    ...
    <div class="container-fluid">
          <div class="box box-danger">
            <div class="box-header with-border">
              <h3 class="box-title">List acc pengajuan kegiatan yayasan</h3>
            ...
            <div class="box-body">
                ...
                <table class="table" id="tbl_pengajuan" class="table table-bordered table-hover">
                    ...
                    <tbody>
                        <?php
                            if(count($data_kegiatan_yayasan))
                            {
                                        $i=1;
                                foreach($data_kegiatan_yayasan as $a)
                                {   
                                    ...
                                    echo                    "<td>
                                                                        <select name='' id='status_pengajuan' class='form-control'>
                                                                                    <option value=''>-- Select One --</option>";
                                                                                                ...
                                                                                                if($a['status_pengajuan']==1 and $a['tgl_review_pengajuan_kegiatan']!="")
                                                                                                {
                                                                                                ...
                                                                                                if($a['status_pengajuan']==0 and $a['tgl_review_pengajuan_kegiatan']!="")
                                                                                                {
                                    ...
                                    echo                    "<td><textarea  class='form-control' id='ket_review_pengajuan' cols='20' rows='3'>".$a['ket_review_pengajuan_kegiatan']."</textarea></td>";
...
$("body").on("click","#btn_simpan", function () {
    ...
    var status_pengajuan= row.find("#status_pengajuan").val();
    var ket_review_pengajuan= row.find("#ket_review_pengajuan").val();
    var tgl_review_pengajuan="<?php echo date('Y-m-d');?>";
    ...
    $.confirm({
            ...
            buttons: {
                confirm: function () {
                    $.ajax({
                        type: "POST",
                        url: "<?php echo base_url();?>index.php/modul_kegiatan/acc_pengajuan_kegiatan/aksi_edit_acc_pengajuan_kegiatan",
