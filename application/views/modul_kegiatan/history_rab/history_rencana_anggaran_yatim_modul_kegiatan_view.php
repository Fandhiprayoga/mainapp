...
<section class="content-header">
      <h1>
        histori rencana anggaran yatim
        <small>Halaman kelola histori rencana anggaran yatim</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fas fa-home"></i> Beranda</a></li>
        <li><a href="#">list histori rencana anggaran yatim</a></li>
    ...
    <div class="container-fluid">
          <div class="box box-danger">
            <div class="box-header with-border">
              <h3 class="box-title">List histori rencana anggaran yatim</h3>
            ...
            <span>
                <select style="width:90%;" name="" id="pilih_id_pengajuan" class="form-control js-example-basic-single">
                    ...
                    <?php
                                                    $a=$this->db->query("select * from pengajuan where status_proposal='1' and kategori_pengajuan='yatim' order by id_pengajuan desc ")->result_array();
                                                    if(count($a))
                                                    {
                                                        foreach($a as $a)
                                                        {
