...
<section class="content-header">
      <h1>
        Laporan dana kegiatan yatim
        <small>Halaman laporan dana kegiatan yatim</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fas fa-home"></i> Beranda</a></li>
        <li><a href="#">Laporan dana kegiatan yatim</a></li>
    ...
    <div class="container-fluid">
          <div class="box box-danger">
            <div class="box-header with-border">
              <h3 class="box-title">Laporan dana kegiatan yatim</h3>
...
$("#btn_tampil").click(function (e) { 
            ...
            else
            {
                $.ajax({
                        type: "post",
                        url: "<?php echo base_url();?>index.php/modul_keuangan_yatim/laporan/tampil_pengajuan_list",
...
$("#btn_cetak").click(function (e) { 
            ...
            { 
                location.href="<?php echo base_url();?>index.php/modul_keuangan_yatim/laporan/cetak_laporan_kegiatan/"+tgl_awal+"/"+tgl_akhir;
            }
