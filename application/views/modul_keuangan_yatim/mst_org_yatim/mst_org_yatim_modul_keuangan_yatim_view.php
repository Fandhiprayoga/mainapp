...
<section class="content-header">
    <h1>
        Master organisasi yatim
        <small>Halaman kelola yatim</small>
    </h1>
    <ol class="breadcrumb">
        <li>
            <a href="#">
        ...
        <li>
            <a href="<?php echo base_url();?>index.php/modul_admin/mst_donatur">Data organisasi yatim</a>
        </li>
    ...
    <div class="container-fluid">
        <div class="box box-danger">
            <div class="box-header with-border">
                <h3 class="box-title">Tambah data organisasi yatim</h3>
            ...
            <!-- /.box-header -->
            <div class="box-body">
            <?php $a=$this->db->query("select * from mst_org_yatim where substring(id_org_yatim,1,8)='".date('Y')."".date('m')."".date('d')."'")->num_rows();
                    $b=$a+1;
            ?>
                ...
                <div class="table-responsive">
                    <table class="table table-hover table-bordered" id="table_donatur">
                        ...
                        <tbody>
                            ...
                            <?php
                        if(count($data_mst_org_yatim))
                        {
                            $i=1;
                            foreach($data_mst_org_yatim as $d)
                            {
                                echo '<tr>
                                        <td id_org_yatim="'.$d['id_org_yatim'].'" class="id_org_yatim">'.$i.'</td>
                                        <td>'.$d['id_org_yatim'].'</td>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Edit data org yatim</h4>
            </div>
...
setDefaultActive();
    ...
    $('#btn_simpan').on('click', function () {
        ...
        if (nama == "" || jk == "" || tempat_lahir == ""||tanggal_lahir == ""||jabatan==""||alamat=="") {
            ...
            $.ajax({
                type: "post",
                url: "<?php echo base_url();?>/index.php/modul_keuangan_yatim/mst_org_yatim/aksi_tam" +
                        "bah_mst_org_yatim",
                data: {
                    id_org_yatim: id,
                    nama: nama,
    ...
    $("body").on("click", "#btn_hapus", function () {
        ...
        var id_org_yatim = row
            .find(".id_org_yatim")
            .attr('id_org_yatim'); // Find the text
        // alert(id_donatur);
        $.ajax({
            type: "post",
            url: "<?php echo base_url();?>index.php/modul_keuangan_yatim/mst_org_yatim/aksi_hapu" +
                    "s_mst_org_yatim",
            data: {
                id_org_yatim: id_org_yatim
            },
            dataType: "json",
            success: function (data) {
    ...
    $("body").on("click","#btn_edit", function () {
      var row = $(this).closest("tr"); // Find the row
        var id_org_yatim= row .find(".id_org_yatim").attr('id_org_yatim'); // Find the text
        ...
        //alert(id_org_yatim+nama+jk+tempat_lahir+tanggal_lahir+jabatan+alamat);
        //alert(tempat_lahir+tanggal_lahir);
        $("#id_edit").val(id_org_yatim);
        $("#nama_edit").val(nama);
        $("#jk_edit").val(jk);
    ...
    $("body").on("click","#btn_simpan_edit", function () {
        ...
        $.ajax({
          type: "post",
          url: "<?php echo base_url();?>index.php/modul_keuangan_yatim/mst_org_yatim/aksi_edit_mst_org_yatim",
          data: {id_org_yatim:id_org_yatim,nama:nama,jk:jk,alamat:alamat,tempat_lahir:tempat_lahir,tanggal_lahir:tanggal_lahir,jabatan:jabatan},
          dataType: "json",
