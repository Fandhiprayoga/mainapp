...
<head>
  ...
  <title><?php echo $a[0]['nama_mainapp'];?> | MODUL KEUANGAN YATIM</title>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <li class=""><a href="<?php echo base_url();?>index.php/modul_keuangan_yatim/beranda"><i class="fa fa-home"></i> <span>Beranda</span></a></li>
        ...
        <?php
            ...
            $data_menu=$this->db->query("select * from menu where id_modul='14' order by order_menu asc" )->result_array();
