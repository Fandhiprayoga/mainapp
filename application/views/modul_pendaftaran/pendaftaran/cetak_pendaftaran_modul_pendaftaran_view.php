...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <div class="grid">
            ...
            <?php $a=$this->db->query('select * from pendaftaran where id_pendaftaran="'.$id_pendaftaran.'"')->result_array();?>
                <tbody>
                    <tr>
                        ...
                        <td style="width:60%;"><?php echo $a[0]['n_pendaftaran'];?></td>
                    </tr>
                    <tr>
                        <td>NAMA PANGGILAN </td>
                        <td style="width:5px;">:&nbsp; </td>
                        <td><?php echo $a[0]['nl_pendaftaran'];?></td>
                    </tr>
                    <tr>
                        <td>TEMPAT TANGGAL LAHIR </td>
                        <td style="width:5px;">:&nbsp; </td>
                        <td><?php echo $a[0]['t_pendaftaran'];?>, <?php echo $a[0]['tl_pendaftaran'];?></td>
                    </tr>
                    <tr>
                        <td>INSTANSI / FAK / JUR </td>
                        <td style="width:5px;">:&nbsp; </td>
                        <td><?php echo $a[0]['instansi_pendaftaran'];?></td>
                    </tr>
                    <tr>
                        <td>ALAMAT </td>
                        <td style="width:5px;">:&nbsp; </td>
                        <td><?php echo $a[0]['alamat_pendaftaran'];?></td>
                    </tr>
                    <tr>
                        <td>NO TELP </td>
                        <td style="width:5px;">:&nbsp; </td>
                        <td><?php echo $a[0]['telp_pendaftaran'];?></td>
                    </tr>
                    <tr>
                        <td>EMAIL / FB</td>
                        <td style="width:5px;">:&nbsp; </td>
                        <td><?php echo $a[0]['email_pendaftaran'];?></td>
                    </tr>
                    <tr>
                        <td>PENGALAMAN ORGANISASI</td>
                        <td style="width:5px;">:&nbsp; </td>
                        <td ><?php echo $a[0]['org_pendaftaran'];?></td>
                    </tr>
                    <tr>
                        <td>DAFTAR PRESTASI</td>
                        <td style="width:5px;">:&nbsp; </td>
                        <td><?php echo $a[0]['prestasi_pendaftaran'];?></td>
                    </tr>
                    <tr>
                        <td>ALASAN MASUK</td>
                        <td style="width:5px;">:&nbsp; </td>
                        <td><?php echo $a[0]['alasan_pendaftaran'];?></td>
                    </tr>
                </tbody>
            </table>
        </div>
        ...
        <div class="footer">
            <br>
            <p style="margin-bottom:90px;margin-left:400px;">Pamulang,&nbsp;<?php echo date("Y/m/d");?></p>
            <p style="margin-left:400px;">(<?php echo $a[0]['n_pendaftaran'];?>)</p>
        </div>
    </div>
