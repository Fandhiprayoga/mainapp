...
<body>
         <div class="grid">
            ...
            <?php
                        if($santri=="0")
                        {
                                    $query="SELECT p.*, bi.status_bayar_infaq FROM pendaftaran p LEFT JOIN bayar_infaq bi ON p.id_pendaftaran=bi.id_pendaftaran AND bi.id_infaq='".$infaq."' and bi.status_bayar_infaq!=1 where SUBSTRING(p.id_pendaftaran,3,4)='".date('Y')."' ORDER BY p.id_pendaftaran DESC";
                                    ...
                                    if(count($a))
                                    {
                                                ...
                                                echo '<div class="tabel_plate">
                                                                        ...
                                                                        <p align="center" style="font-weight:bold;">
                                                                                    Data Belum Bayar Infaq Calon Santri ('.$infq[0]['nama_infaq'].')</p>
                                                                        <br>
                                                                        <table>
                                                                                    <thead>
                                                                                    <tr>
                        ...
                        {
                                    $query="SELECT p.*, bi.* FROM mst_santri p LEFT JOIN bayar_infaq bi ON p.id_santri=bi.id_pendaftaran AND bi.id_infaq='".$infaq."' and bi.status_bayar_infaq!=1 ORDER BY p.id_santri DESC";
                                    $a=$this->db->query($query)->result_array();
                                    if(count($a))
                                    {
                                                $infq=$this->db->query("select nama_infaq from mst_infaq where id_infaq='".$infaq."'")->result_array();
                                                echo '<div class="tabel_plate">
                                                                        ...
                                                                        <p align="center" style="font-weight:bold;">
                                                                                    Data Belum Bayar Infaq Santri ('.$infq[0]['nama_infaq'].')</p>
                                                                        <br>
                                                                        <table>
                                                                                    <thead>
                                                                                    <tr>
