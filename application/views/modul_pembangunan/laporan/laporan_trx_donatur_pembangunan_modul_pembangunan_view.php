...
$("#btn_tampil").click(function (e) { 
            ...
            else
            {
                $.ajax({
                        type: "post",
                        url: "<?php echo base_url();?>index.php/modul_pembangunan/laporan/tampil_donatur",
                        ...
                        success: function (data) {
                                    ...
                                    if(data.length>0)
                                    {
                                        ...
                                        {
                                            html += "<tr>"+
                                                        "<td id_pengajuan='"+data[i].id_trx_donatur_pembangunan+"' id='id_pengajuan'>"+(i+1)+"</td>"+
                                                        "<td>"+data[i].nama_donatur+"</td>"+
                                                        "<td>"+data[i].telp_donatur+"</td>"+
                                                        "<td>"+data[i].alamat_donatur+"</td>"+
                                                        "<td>"+data[i].tgl_trx_donatur_pembangunan+"</td>"+
                                                        "<td>Rp."+data[i].nominal_trx_donatur_pembangunan+"</td>"+
                                                    "</tr>";
                                        }
...
$("#btn_cetak").click(function (e) { 
            ...
            { 
                location.href="<?php echo base_url();?>index.php/modul_pembangunan/laporan/cetak_laporan_donatur/"+tgl_awal+"/"+tgl_akhir;
            }
