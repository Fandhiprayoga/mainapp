...
<body>
    ...
    <div class="grid">
        ...
        <div class="tabel_plate">
            <hr>
            <br>
            <p align="center" style="font-weight:bold;">LAPORAN DANA KEGIATAN PEMBANGUNAN
            ...
            <table >
                ...
                <?php 
                            ...
                            from pengajuan 
                            where status_lpj='1' and kategori_pengajuan='pembangunan' and tgl_pengajuan between '".$tgl_awal."' and '".$tgl_akhir."'")->result_array();
