...
<section class="content-header">
      <h1>
        Laporan dana kegiatan pembangunan
        <small>Halaman laporan dana kegiatan pembangunan</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fas fa-home"></i> Beranda</a></li>
        <li><a href="#">Laporan dana kegiatan pembangunan</a></li>
    ...
    <div class="container-fluid">
          <div class="box box-danger">
            <div class="box-header with-border">
              <h3 class="box-title">Laporan dana kegiatan pembangunan</h3>
            ...
            <span><label for="">Filter Tanggal kegiatan :</label>    
                        <table>
                                    <tr>
                                                <td>
...
$("#btn_tampil").click(function (e) { 
            ...
            else
            {
                $.ajax({
                        type: "post",
                        url: "<?php echo base_url();?>index.php/modul_pembangunan/laporan/tampil_pengajuan_list",
                                    ...
                                    if(data.length>0)
                                    {
                                        for(i=0;i<data.length;i++)
                                        {
                                            html += "<tr>"+
                                                        ...
                                                        "<td>Rp."+data[i].rencana_anggaran+"</td>"+
                                                    "</tr>";
                                        }
                                        html +="<tr class='warning'><td colspan='6' align='center'><b>TOTAL</b></td><td>Rp."+data[0].total+"</td></tr>";
                                    }
                                    else
                                    {
...
$("#btn_cetak").click(function (e) { 
            ...
            { 
                location.href="<?php echo base_url();?>index.php/modul_pembangunan/laporan/cetak_laporan_kegiatan/"+tgl_awal+"/"+tgl_akhir;
            }
