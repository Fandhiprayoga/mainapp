...
<head>
    ...
    <title>LAPORAN TRANSAKSI DONATUR PEMBANGUNAN</title>
    <style>
        .grid{
            padding:30px;
        }
...
<body>
    ...
    <div class="grid">
        ...
        <div class="tabel_plate">
            <hr>
            <br>
            <p align="center" style="font-weight:bold;">LAPORAN TRANSAKSI DONATUR PEMBANGUNAN
            ...
            <table >
                ...
                <?php 
                            ...
                            where tgl_trx_donatur_pembangunan between '".$tgl_awal."' and '".$tgl_akhir."'")->result_array();
                            ...
                            if(count($a))
                            {
                                ...
                                foreach($a as $a)
                                {
                                    echo "<tr style='width:100%;'>
                                            ...
                                            <td>".$a['tgl_trx_donatur_pembangunan']."</td>
                                            <td>Rp.".$a['nominal_trx_donatur_pembangunan']."</td>
                                        </tr>";
                                        $i++;
                                }
