...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li>
            <a href="<?php echo base_url();?>index.php/modul_admin/mst_donatur">Data organisasi pembangunan</a>
        </li>
    ...
    <div class="container-fluid">
        <div class="box box-danger">
            <div class="box-header with-border">
                <h3 class="box-title">Tambah data organisasi pembangunan</h3>
            ...
            <!-- /.box-header -->
            <div class="box-body">
            <?php $a=$this->db->query("select * from mst_org_pembangunan where substring(id_org_pembangunan,1,8)='".date('Y')."".date('m')."".date('d')."'")->num_rows();
                    $b=$a+1;
            ?>
                ...
                <div class="table-responsive">
                    <table class="table table-hover table-bordered" id="table_donatur">
                        ...
                        <tbody>
                            ...
                            <?php
                        if(count($data_mst_org_pembangunan))
                        {
                            $i=1;
                            foreach($data_mst_org_pembangunan as $d)
                            {
                                echo '<tr>
                                        <td id_org_pembangunan="'.$d['id_org_pembangunan'].'" class="id_org_pembangunan">'.$i.'</td>
                                        <td>'.$d['id_org_pembangunan'].'</td>
...
setDefaultActive();
    ...
    $('#btn_simpan').on('click', function () {
        ...
        if (nama == "" || jk == "" || tempat_lahir == ""||tanggal_lahir == ""||jabatan==""||alamat=="") {
            ...
            $.ajax({
                type: "post",
                url: "<?php echo base_url();?>/index.php/modul_pembangunan/mst_org_pembangunan/aksi_tam" +
                        "bah_mst_org_pembangunan",
                data: {
                    id_org_pembangunan: id,
                    nama: nama,
                    jk: jk,
    ...
    $("body").on("click", "#btn_hapus", function () {
        ...
        var id_org_pembangunan = row
            .find(".id_org_pembangunan")
            .attr('id_org_pembangunan'); // Find the text
        // alert(id_donatur);
        $.ajax({
            type: "post",
            url: "<?php echo base_url();?>index.php/modul_pembangunan/mst_org_pembangunan/aksi_hapu" +
                    "s_mst_org_pembangunan",
            data: {
                id_org_pembangunan: id_org_pembangunan
            },
            dataType: "json",
            success: function (data) {
    ...
    $("body").on("click","#btn_edit", function () {
        var row = $(this).closest("tr"); // Find the row
        var id_org_pembangunan= row .find(".id_org_pembangunan").attr('id_org_pembangunan'); // Find the text
        ...
        $("#id_edit").val(id_org_pembangunan);
        $("#nama_edit").val(nama);
        $("#jk_edit").val(jk);
    ...
    $("body").on("click","#btn_simpan_edit", function () {
        var id_org_pembangunan= $("#id_edit").val();
        ...
        $.ajax({
          type: "post",
          url: "<?php echo base_url();?>index.php/modul_pembangunan/mst_org_pembangunan/aksi_edit_mst_org_pembangunan",
          data: {id_org_pembangunan:id_org_pembangunan,nama:nama,jk:jk,alamat:alamat,tempat_lahir:tempat_lahir,tanggal_lahir:tanggal_lahir,jabatan:jabatan},
          dataType: "json",
