...
class Laporan extends CI_Controller{
    ...
    function __construct() {
        parent::__construct();
        $this->load->model('modul_keuangan_yayasan/laporan_model');
    }
    ...
    public function laporan_donatur()
    {
        ...
        {
            $data['page']='modul_keuangan_yayasan/laporan/laporan_trx_donatur_yayasan_modul_keuangan_yayasan_view';
    ...
    public function cetak_laporan_donatur()
    {
        ...
        $this->pdf->filename = "data_donatur_yayasan.pdf";
        $this->pdf->load_view('modul_keuangan_yayasan/laporan/cetak_laporan_trx_donatur_yayasan_modul_keuangan_yayasan_view', $data);
    }
    ...
    public function laporan_kegiatan()
    {
        ...
        {
            $data['page']='modul_keuangan_yayasan/laporan/laporan_kegiatan_yayasan_modul_keuangan_yayasan_view';
            $this->load->view('modul_keuangan_yayasan/dasbor_modul_keuangan_yayasan_view', $data);
        }
    ...
    public function cetak_laporan_kegiatan()
    {
        ...
        $this->pdf->load_view('modul_keuangan_yayasan/laporan/cetak_laporan_kegiatan_yayasan_modul_keuangan_yayasan_view', $data);
    }

    public function tampil_donatur()
    {
         $data=$this->laporan_model->tampil_trx_donatur_yayasan_list();
