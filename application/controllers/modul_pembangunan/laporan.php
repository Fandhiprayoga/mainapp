...
class Laporan extends CI_Controller{
    ...
    function __construct() {
        parent::__construct();
        $this->load->model('modul_pembangunan/laporan_model');
    }
    ...
    public function laporan_donatur()
    {
        ...
        {
            $data['page']='modul_pembangunan/laporan/laporan_trx_donatur_pembangunan_modul_pembangunan_view';
    ...
    public function cetak_laporan_donatur()
    {
        ...
        $this->pdf->filename = "data_donatur_pembangunan.pdf";
        $this->pdf->load_view('modul_pembangunan/laporan/cetak_laporan_trx_donatur_pembangunan_modul_pembangunan_view', $data);
    }
    ...
    public function laporan_kegiatan()
    {
        ...
        {
            $data['page']='modul_pembangunan/laporan/laporan_kegiatan_pembangunan_modul_pembangunan_view';
            $this->load->view('modul_pembangunan/dasbor_modul_pembangunan_view', $data);
        }
    ...
    public function cetak_laporan_kegiatan()
    {
        ...
        $this->pdf->load_view('modul_pembangunan/laporan/cetak_laporan_kegiatan_pembangunan_modul_pembangunan_view', $data);
    }

    public function laporan_gaji_tukang()
    {
        if($this->session->id_user=="")
        {
            redirect(base_url('index.php/auth'), 'refresh');
        ...
        {
            $data['page']='modul_pembangunan/laporan/laporan_gaji_tukang_modul_pembangunan_view';
            $this->load->view('modul_pembangunan/dasbor_modul_pembangunan_view', $data);
        }
        
    }

    public function cetak_laporan_gaji_tukang()
    {
        $data['id_pengajuan']=$this->uri->segment('4');

        $this->load->library('pdf');
        $this->pdf->setPaper('A4', 'potrait');
        $this->pdf->filename = "data_gaji_tukang.pdf";
        $this->pdf->load_view('modul_pembangunan/laporan/cetak_laporan_gaji_tukang_modul_pembangunan_view', $data);
    }

    public function tampil_donatur()
    {
         $data=$this->laporan_model->tampil_trx_donatur_pembangunan_list();
    ...
    {
        $data=$this->laporan_model->tampil_gaji_tukang_list();
        echo json_encode($data);
    }
...
//             $data['page']='modul_pembangunan/mst_donatur/tambah_mst_donatur_pembangunan_view';
