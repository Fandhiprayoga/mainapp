...
class acc_pengajuan_kegiatan_model extends CI_Model{
    ...
    public function tampil_acc_pengajuan_kegiatan_pembangunan_list()
    {
        $query = $this->db->query("select * from pengajuan where kategori_pengajuan='pembangunan' order by id_pengajuan desc");
        return $query->result_array();
    }
